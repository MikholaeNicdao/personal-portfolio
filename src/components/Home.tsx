...
const Home = () => {
  return (
    <div id="Home" className='flex justify-center items-center w-full h-screen bg-[#f9eddc]'>
        <div className='max-w-[750px] p-2'>
            ...
            <a href='#' className='animate-bounce border border-[#FD4556] max-w-[150px] p-2 mt-5 flex justify-between items-center duration-300 ease-in-out hover:scale-125 hover:text-white hover:bg-[#BD3944]'>View Work <AiOutlineArrowRight /></a>
        </div>
    </div>
  )
}
